...
INSERT INTO users (family_id, role_id, email, password_hash, full_name, phone, email_verified)
SELECT NULL, r.id, 'admin@mealmate.local', '$2a$10$yTDXwEpBVd0ri5chsz3FyeiUW2amh5jAlfAJR6DmFjJvD32pNFWK2', 'Admin MealMate', '0901112222', TRUE
FROM roles r WHERE r.name = 'ADMIN';

INSERT INTO users (family_id, role_id, email, password_hash, full_name, phone, email_verified)
SELECT NULL, r.id, 'user@mealmate.local', '$2a$10$yTDXwEpBVd0ri5chsz3FyeiUW2amh5jAlfAJR6DmFjJvD32pNFWK2', 'Nguyen Minh Quang', '0912345678', TRUE
FROM roles r WHERE r.name = 'CUSTOMER';

INSERT INTO users (family_id, role_id, email, password_hash, full_name, phone, email_verified)
SELECT NULL, r.id, 'member@mealmate.local', '$2a$10$yTDXwEpBVd0ri5chsz3FyeiUW2amh5jAlfAJR6DmFjJvD32pNFWK2', 'Tran Thu Ha', '0987654321', TRUE
FROM roles r WHERE r.name = 'CUSTOMER';
...
INSERT INTO users (family_id, role_id, email, password_hash, full_name, phone, email_verified)
SELECT fam.id, r.id, v.email, '$2a$10$yTDXwEpBVd0ri5chsz3FyeiUW2amh5jAlfAJR6DmFjJvD32pNFWK2', v.full_name, v.phone, TRUE
FROM (
    VALUES
        ('child@mealmate.local', 'Nguyen Bao An', '0901234567'),
        ('elder@mealmate.local', 'Pham Minh Duc', '0934567890')
