...
CREATE TABLE recipes (
    ...
    preferred_meal_time VARCHAR(50),         -- Bữa ăn phù hợp: BREAKFAST, LUNCH, DINNER

    display_status VARCHAR(50) DEFAULT 'SYSTEM',
                                              -- SYSTEM = Công thức hệ thống
                                              -- CUSTOM = Công thức người dùng tự tạo
